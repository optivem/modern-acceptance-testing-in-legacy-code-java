package com.optivem.eshop.systemtest.dsl.core.app.external.tax;

import com.optivem.eshop.systemtest.driver.port.external.tax.TaxDriver;
import com.optivem.eshop.systemtest.dsl.core.app.external.tax.usecases.GetTaxRate;
import com.optivem.eshop.systemtest.dsl.core.app.external.tax.usecases.GoToTax;
import com.optivem.eshop.systemtest.dsl.core.app.external.tax.usecases.ReturnsTaxRate;
