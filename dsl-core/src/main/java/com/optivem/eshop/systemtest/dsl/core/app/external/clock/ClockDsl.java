package com.optivem.eshop.systemtest.dsl.core.app.external.clock;

import com.optivem.eshop.systemtest.driver.port.external.clock.ClockDriver;
import com.optivem.eshop.systemtest.dsl.core.app.external.clock.usecases.GetTime;
import com.optivem.eshop.systemtest.dsl.core.app.external.clock.usecases.GoToClock;
import com.optivem.eshop.systemtest.dsl.core.app.external.clock.usecases.ReturnsTime;
