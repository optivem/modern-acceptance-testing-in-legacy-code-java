package com.optivem.eshop.dsl.core.app.external.clock;

import com.optivem.eshop.dsl.driver.port.external.clock.ClockDriver;
import com.optivem.eshop.dsl.core.app.external.clock.usecases.GetTime;
import com.optivem.eshop.dsl.core.app.external.clock.usecases.GoToClock;
import com.optivem.eshop.dsl.core.app.external.clock.usecases.ReturnsTime;
